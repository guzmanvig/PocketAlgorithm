...
% Test set as the first half othe shuffled data
...
% Training set as the second half othe shuffled data
...
w = rand(size(X,2), 1);  % initial coefficients using random numbers between 0 and 1
